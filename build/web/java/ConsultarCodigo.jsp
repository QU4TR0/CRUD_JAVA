    ...
    <body>
        <%
            ...
            try {
                ...
                PreparedStatement st = conexao.prepareStatement("SELECT * FROM produtos p WHERE codigo LIKE ?");
                st.setInt(1, codigo);
                ...
                while (resultado.next()) { //Faça enquanto tiver produtos na variável resultado
                   out.print("<tr><td>" + resultado.getString("codigo") + 
                           "</td><td>" + resultado.getString("nome") + 
                           "</td><td>" + resultado.getString("marca") + 
                           "</td><td>" + resultado.getString("preco") + 
                           "</td><td><a href='ExcluirProdutos.jsp?codigo=" + resultado.getString("codigo") + "'>Excluir</a></td><td><a href='BuscarProdutos.jsp?codigo=" + resultado.getString("codigo") +"'>Alterar</a></td></tr>");
                }
                out.print("</table>");
